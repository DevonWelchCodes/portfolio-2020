    ...
    <>
     ...
     <ThemeToggler>
      ...
      <div className="social-icons">
        <a target="_blank" href="https://github.com/DevonDevs"><div className="social-icon rounded-full border-2 border-primary w-7 h-7 flex items-center justify-center transition-primary hover:bg-primary cursor-pointer mb-1">
        ...
        <a target="_blank" href="https://ca.linkedin.com/in/devon-welch-6b7724132"><div className="social-icon rounded-full border-2 border-primary w-7 h-7 flex items-center justify-center transition-primary hover:bg-primary cursor-pointerxw">
        ...
        <div className="relative h-full overflow-hidden flex items-center text-wrapper">
        ...
        <div className="body-wrapper-fake relative wrapper-fake--menu my-8 mx-10 rounded-xlg z-49">
